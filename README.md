...
- Comentamos las lineas con los path de las listas blancas y negras.
> var WHITE_LIST_PATH ../rules
> var BLACK_LIST_PATH ../rules

- Habilitamos dos directorios, uno para el archivo de filtros IP y otro para los archivos de registro de operaciones y alertas.
**Para los archivos de filtros IP**
Primero creamos el fichero **snort.bpf** en el directorio **c:\snort\rules\.** y luego configuramos la regla.
> config bpf_file: c:\snort\rules\snort.bpf

**Para los archivos de registro de operaciones y alertas**
> config logdir: c:\snort\log

- Cambiamos la ruta de las bibliotecas dinamicas que usa el programa por rutas absolutas.
> dynamicengine c:\snort\lib\snort_dynamicengine\sf_engine.dll

- Comentamos la siguiente linea añadiendo un **#** al principio de la linea.
> dynamicdetection directory /usr/local/lib/snort_dynamicrules

- Configuramos los pre-procesadores
